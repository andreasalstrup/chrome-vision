...
class ChromeMoCoV2(nn.Module):
      def __init__(self, base_encoder, feature_dim=(1000, 10), queue_size=65536, momentum=0.999, softmax_temp=0.07):
            """
            ...
            super(ChromeMoCoV2, self).__init__()
            ...
            self.register_buffer("queue", torch.randn(feature_dim[1], queue_size))
